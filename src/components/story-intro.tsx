...
/**
 * A single-question narrative beat: large left-aligned headline, 2–3 lines of
  ...
  return (
    <section className="px-6 py-20 sm:py-28">
      <Reveal className="mx-auto max-w-6xl">
        <h2 className="max-w-3xl font-display text-display-lg font-semibold tracking-tight text-ink">
          {headline}
        </h2>
