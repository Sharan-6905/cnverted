...
const tagIcons = {
  ...
  X: <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.261 5.632 5.903-5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', border: '1px solid var(--border)' }}>
      {items.map((item, i) => (
        ...
        >
          <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.06em', color: 'var(--text-subtle)', display: 'flex', alignItems: 'center', gap: 5 }}>
